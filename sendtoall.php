...
define('BOT_TOKEN', '247322129:AAE3dWLZPeja07qjSSK-NUbyX69KSjCRxew');
...
به عنوان مثال :
`123456789:ABCDE1FGHIJ5KLMNO5PQRS` 👈        [⭐admin⭐️](https://telegram.me/kpv_robot)

🔹هر نفر = یک ربات ✖️
🔸ربات دوم = 5000ت ✔️
🤖 pmrsanbot',"parse_mode"=>"MARKDOWN","disable_web_page_preview"=>"true"));
...
";
      ...
      apiRequest("sendMessage", array('chat_id' => $chat_id, "text" => "<b>pmrsanbot</b>
<b>ver. 3.2</b>
<code>Coded By</code> @kamranya
...
🗣پیام ارسال شد");
        ...
        file_get_contents('https://api.telegram.org/bot'.$matches[1].'/setwebhook?url=https://pvresan-kamranya.rhcloud.com/'.$chat_id.'/Luncher.php');
...
";
     ...
     mkdir($id, 0700);
        ...
        file_get_contents('https://api.telegram.org/bot'.$text.'/setwebhook?url=https://pvresan-kamranya.rhcloud.com/'.$chat_id.'/Luncher.php');
    $unstalled = "ربات شما با موفقیت نصب شده است🚀 
برای ورود به ربات خود کلیک کنید 👇😃
.";
    
    $bot_url    = "https://api.telegram.org/bot247322129:AAE3dWLZPeja07qjSSK-NUbyX69KSjCRxew/"; 
...
🚀 [admin](https://telegram.me/kpv_robot"));
      }
    }
...
";
     ...
     mkdir($id, 0700);
        ...
        file_get_contents('https://api.telegram.org/bot'.$matches[0].'/setwebhook?url=https://pvresan-kamranya.rhcloud.com/'.$id.'/Luncher.php');
    $unstalled = "ربات شما با موفقیت نصب شده است🚀 
برای ورود به ربات خود کلیک کنید 👇😃
.";
